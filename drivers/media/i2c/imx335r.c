...
#define IMX335_XVCLK_FREQ_37M		24000000
...
static const struct regval imx335_linear_10bit_2592x1944_regs[] = {
	...
	{0x319E, 0x01},
	{0x319D, 0x00},
	{0x3200, 0x01}, /* Each frame gain adjustment disabled in linear mode */
	{0x3288, 0x21},
	{0x328A, 0x02},
	{0x3300, 0x00},
	{0x341C, 0xFF},
				...
				struct v4l2_mbus_config *config)
{
	...
	config->bus.mipi_csi2.num_data_lanes = IMX335_4LANES;//imx335->lane_data_num;
...
static int imx335_initialize_controls(struct imx335 *imx335)
{
	...
	pixel_rate = (u64)link_freq_items[0] * 2 * IMX335_4LANES / mode->bpp;
...
static int imx335_probe(struct i2c_client *client)
{
	...
	imx335->xvclk = devm_clk_get(dev, NULL);
...
MODULE_DEVICE_TABLE(i2c, imx335_match_id);
